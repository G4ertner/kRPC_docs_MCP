...
def get_navigation_info(address: str, rpc_port: int = 50000, stream_port: int = 50001, name: str | None = None, timeout: float = 5.0) -> str:
    """
    Provide coarse navigation info to the current target (body or vessel):
    - For body: phase angle around common parent, orbital elements
    - For vessel: distance, relative speed, relative inclination, phase angle
    """
    conn = _connect(address, rpc_port, stream_port, name, timeout)
